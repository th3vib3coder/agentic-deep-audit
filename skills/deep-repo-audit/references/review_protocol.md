...
- Every generated audit packet includes a `REVIEW_LEDGER.md` runtime artifact.
- A reviewer different from the author checks scope, tests, gate behavior and drift from the stated audit contract.
